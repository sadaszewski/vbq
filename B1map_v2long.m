...
% $Id: B1map_v2long.m 265 2011-08-01 10:58:48Z nikolaus $
...
for p = 1:V(1).dim(3),%loop over the partition dimension of the data set
    ...
    [values indexes]=sort(Temp_mat,3);
...
[p,name,e,v] = fileparts(V_save.fname);
...
[p,name,e,v] = fileparts(W_save.fname);
...
[p,name,e,v] = fileparts(X_save.fname);
...
[path,name,e,v] = fileparts(anat_img1.fname);
%anat_img = {strcat(path,'\',name,e)};
